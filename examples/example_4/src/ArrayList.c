...
int al_push(ArrayList* this, int index, void* pElement)
{
    int returnAux = -1;
     if(this!=NULL && pElement!=NULL && index>=0 && index<=this->len(this))
     {
         ...
         {
             this->set(this,index,pElement);//this->set();
         }
         returnAux=0;
     }
...
/** \brief Returns true if this list contains no elements.reservedSize
 * \param pList ArrayList* Pointer to arrayList
...
int resizeUp(ArrayList* this)
{
    ...
    if(this!=NULL)
        {
            int cantidad=this->reservedSize+AL_INCREMENT;

            aux=realloc(this->pElements,sizeof(void*)*(cantidad));
            if(aux!=NULL)
            {
                this->reservedSize=cantidad;
                this->pElements=aux;
                returnAux=0;
            }
        }
...
int expand(ArrayList* this,int index)
{
    ...
    if(this!=NULL&&index>=0)
    {
        ...
        {
            *(this->pElements+(i+1))=*(this->pElements+1);
        }
        this->size++;
        returnAux = 0;
    }
